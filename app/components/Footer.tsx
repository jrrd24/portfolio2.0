...
const Footer = (props: Props) => {
  ...
  return (
    <footer className="w-screen py-4 border-t-2 border-custom-dark dark:border-white/20">
      <div className="flex flex-col md:flex-row  lg:pt-1 md:my-2 my-0 pb-2 px-8 md:px-24  ">
        <div className="flex flex-col items-center md:items-start gap-0 w-full   ">
          ...
          <div className=" flex md:flex-row flex-col-reverse md:gap-0 gap-8 items-center justify-between items-end w-full">
            ...
            <div className=" text-xs lg:text-sm md:text-right text-center">
